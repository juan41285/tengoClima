 ...
 */
var ClimaPage = /** @class */ (function () {
    function ClimaPage(geolocation, platform, locationAccuracy, climaProvider) {
        this.geolocation = geolocation;
        this.platform = platform;
        this.locationAccuracy = locationAccuracy;
        this.climaProvider = climaProvider;
    }
    ClimaPage.prototype.ionViewDidLoad = function () {
        this.enableLocation();
    };
    //Obtener ubicacion y devolver lat y logn
    ClimaPage.prototype.getLocation = function () {
    ...
    ClimaPage.prototype.enableLocation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                        ...
                        this.locationAccuracy.canRequest().then(function (canRequest) {
                            ...
                            if (canRequest) {
                                ...
                                _this.locationAccuracy
                                    .request(_this.locationAccuracy.REQUEST_PRIORITY_HIGH_ACCURACY)
                                    .then(function () {
                                    console.log('canRequest', canRequest);
                                    _this.getLocation();
